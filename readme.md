...
This novel shows interesting mix of hard sci-fi, Nordic noir, parallel / alternative universe tree and path backtracking. The main protagonist is fighting the global cataclysm in it's own style. The storytelling is so unique I'm afraid noone would be able to make a film based on this masterpiece. There is [great book ending explanation](https://www.thisisbarry.com/book/the-gone-world-ending-explained-tom-sweterlitsch-book/) there. [@4ndrej](https://github.com/4ndrej)
